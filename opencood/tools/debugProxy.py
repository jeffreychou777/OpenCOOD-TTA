...
os.chdir('/home/junfei.zhou/DATACENTER2/data/code/OpenCOOD-TTA')
...
selfatt_args = 'python opencood/tools/train.py --hypes_yaml /home/junfei.zhou/DATACENTER2/data/code/OpenCOOD-TTA/opencood/hypes_yaml/point_pillar_intermediate_fusion.yaml'

selfatt_tta_args = 'python opencood/tools/tta.py --hypes_yaml /home/junfei.zhou/DATACENTER2/data/code/OpenCOOD-TTA/opencood/hypes_yaml/cptta/pointpillar_selfatt_contratta.yaml'
